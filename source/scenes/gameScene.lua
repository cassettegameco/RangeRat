...
local backgroundImg <const> = gfx.image.new("images/RatRange-BG-2")
assert(backgroundImg)

local golferTable <const> = gfx.imagetable.new("images/Rat-v2")
...
local TestImpactSoundSet <const> = {
...
-- create a reusable image for the ball
local ballImage = gfx.image.new(6, 6)
-- ⚠️ is it possible to turn this push/pop into a reusable global function?
...
function GameScene:init()
    ...
    -- ⚠️ is this the right place for this?
